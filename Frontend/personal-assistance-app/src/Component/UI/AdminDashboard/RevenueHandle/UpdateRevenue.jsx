...
export default function UpdateRevenue({ onCancel, revenue }) {
  const [revenueDetails, setRevenueDetaails] = useState({
    id: revenue.id,
    renenueDate: revenue.Date,
  ...
  const updateSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "http://localhost:8070/adminDashBoard/Financial/updateRevenue",
        {
          id: revenueDetails.id,
          date: revenueDetails.renenueDate,
          expence: revenueDetails.revenue,
