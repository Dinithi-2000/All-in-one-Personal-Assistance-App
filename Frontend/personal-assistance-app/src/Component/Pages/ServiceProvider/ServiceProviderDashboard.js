...
const ServiceProviderDashboard = () => {
  ...
  const reportData = {
    ...
    recentBookings: [
      { id: 1, client: 'Alice Smith', date: '2025-03-26', duration: '4 hours', status: 'Completed' },
      { id: 2, client: 'Bob Johnson', date: '2025-03-20', duration: '2 hours', status: 'Completed' },
      { id: 3, client: 'Carol Williams', date: '2025-03-15', duration: '3 hours', status: 'Upcoming' },
    ],
  };
  ...
  const generateReport = () => {
    try {
      ...
      doc.text('© 2025 ElderCare Services. All rights reserved.', 105, 285, { align: 'center' });
