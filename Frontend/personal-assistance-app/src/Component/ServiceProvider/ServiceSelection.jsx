...
const ServiceSelection = () => {
  ...
  const handleGetStarted = () => {
    ...
    const serviceRoutes = {
      HouseCleaning: '/housec-selection',
      KitchenHelpers: '/kitchens-selection',
      ChildCare: '/childcares-selection',
      ElderCare: '/elderc-selection',
      PetCare: '/petcares-selection',
      Education: '/educations-selection'
    };
